...
if [[ "${INPUT,,}" == "y" ]]; then
wget -O /usr/local/bin/MiniEditor https://raw.githubusercontent.com/JoshCoder26/MiniUtils/main/MiniEditor.sh
chmod 555 /usr/local/bin/MiniEditor
fi
read -p "Do you want to install MiniMath? (Y/N)" INPUT
if [[ "${INPUT,,}" == "y" ]]; then
wget -O /usr/local/bin/MiniMath https://raw.githubusercontent.com/JoshCoder26/MiniUtils/main/MiniMath.sh
chmod 555 /usr/local/bin/MiniMath
fi
read -p "Do you want to install MiniPass? (Y/N)" INPUT
if [[ "${INPUT,,}" == "y" ]]; then
wget -O /usr/local/bin https://raw.githubusercontent.com/JoshCoder26/MiniUtils/main/MiniPass.sh
